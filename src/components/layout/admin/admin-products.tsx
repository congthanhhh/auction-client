        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter className="gap-2">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white rounded-lg transition-colors flex items-center gap-2"
              disabled={isUpdating}
            >
              {isUpdating ? (
                <>
